...
var useGoogleSheets = function useGoogleSheets(_ref) {
  var apiKey = _ref.apiKey,
      ...
      _ref$sheetsNames = _ref.sheetsNames,
      sheetsNames = _ref$sheetsNames === void 0 ? [] : _ref$sheetsNames;

  var _React$useReducer = React.useReducer(reducer, initialState),
      state = _React$useReducer[0],
      dispatch = _React$useReducer[1];

  var sheets = React.useRef(sheetsNames);
  var fetchData = React.useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
    var mappedData;
